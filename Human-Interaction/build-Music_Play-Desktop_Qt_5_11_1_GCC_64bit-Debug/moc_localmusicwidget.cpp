...
#include "../Music_Play/localmusicwidget.h"
...
QT_MOC_LITERAL(1, 17, 18), // "AlreadyGetFilePath"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 9) // "AddInList"

    },
    "LocalMusicWidget\0AlreadyGetFilePath\0"
    "\0AddInList"
};
...
void LocalMusicWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        LocalMusicWidget *_t = static_cast<LocalMusicWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->AlreadyGetFilePath(); break;
        ...
        {
            using _t = void (LocalMusicWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LocalMusicWidget::AlreadyGetFilePath)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject LocalMusicWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_LocalMusicWidget.data,
      qt_meta_data_LocalMusicWidget,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void LocalMusicWidget::AlreadyGetFilePath()
{
